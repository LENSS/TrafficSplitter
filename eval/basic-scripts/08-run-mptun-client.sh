...
case "${CLIENT_TYPE}" in
    trafficsplitter)
        CLIENT="${ROOT_DIR}/src/MPTun_proxy/build/TrafficSplitter_MPTun_client"
        ;;
    bwr)
        CLIENT="${ROOT_DIR}/src/MPTun_proxy/build/BWR_MPTun_client"
        ;;
    no-batching)
        CLIENT="${ROOT_DIR}/src/MPTun_proxy/build/No-Batching_MPTun_client"
        ;;
    *)
