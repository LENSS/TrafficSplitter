...
case "${SERVER_TYPE}" in
    trafficsplitter)
        SERVER="${ROOT_DIR}/src/MPTun_proxy/build/TrafficSplitter_MPTun_server"
        ;;
    bwr)
        SERVER="${ROOT_DIR}/src/MPTun_proxy/build/BWR_MPTun_server"
        ;;
    no-batching)
        SERVER="${ROOT_DIR}/src/MPTun_proxy/build/No-Batching_MPTun_server"
        ;;
    *)
